...
def ax25_encode_address(include_ssid: str, callsign: str, ssid: int, is_last: bool, command_bit: bool = False) -> bytearray:
    """
...
def ax25_create_frame(include_ssid: str,dst: str, dst_ssid: int, src: str, src_ssid: int, ctrl_type: AX25_Ctrl_Fields, info: bytearray,
    ...
    ax25_frame.extend( ax25_encode_address(include_ssid, dst, dst_ssid, False) )
    ax25_frame.extend( ax25_encode_address(include_ssid, src, src_ssid, True) )
